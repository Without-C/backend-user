...
SECRET_KEY = 'django-insecure-dtq$cqvjcd%z(&=t!=ufjl#)3pfo%t@oc-9&k+b&#g**f2bqu1'
...
OAUTH_UID_GITHUB = os.environ.get('OAUTH_UID_GITHUB')
OAUTH_SECRET_GITHUB = os.environ.get('OAUTH_SECRET_GITHUB')
OAUTH_REDIRECT_GITHUB = os.environ.get('OAUTH_REDIRECT_GITHUB')